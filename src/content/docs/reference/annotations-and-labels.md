...
| `ctxmesh.ai/config-hash` | gateway pod template | The rendered-config hash — changes only when the rendered gateway config changes, rolling the gateway without spurious restarts. |
