...
ctxmesh `0.1.0-beta.4`, use the SDK `0.1.0-beta.4`.

| SDK | Registry | ctxmesh | Tier | Status |
| --- | --- | --- | --- | --- |
| `ctxmesh` (Python) | [PyPI](https://pypi.org/project/ctxmesh/) | `0.1.0-beta.4` | authoring | current |
| `ctxmesh` (TypeScript) | [npm](https://www.npmjs.com/package/ctxmesh) | `0.1.0-beta.4` | authoring | current |
| `ctxmesh` (Go) | [pkg.go.dev](https://pkg.go.dev/github.com/ctxmesh/ctxmesh/sdk/go) | `0.1.0-beta.4` | plane client | current |
| `ctxmesh` (Rust) | [crates.io](https://crates.io/crates/ctxmesh) | `0.1.0-beta.4` | plane client | current |
| `ctxmesh` (Ruby) | [RubyGems](https://rubygems.org/gems/ctxmesh) | `0.1.0-beta.4` | plane client | current |
| `ai.ctxmesh:ctxmesh` (Java) | [Maven Central](https://central.sonatype.com/artifact/ai.ctxmesh/ctxmesh) | `0.1.0-beta.4` | plane client | current |
...
RubyGems also normalises the version string: `0.1.0-beta.4` is published as `0.1.0.pre.beta.3`.
...
- An SDK is supported against **the ctxmesh it shipped with**, and forward against **later
  patches of the same minor** — `0.1.0-beta.4` through `0.1.x`.
